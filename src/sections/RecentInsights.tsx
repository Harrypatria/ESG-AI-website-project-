          ...
          {insights.map((post, index) => (
            ...
            >
              <Link 
                ...
                className="p-10 rounded-[2.5rem] bg-white shadow-[12px_12px_24px_#d1d9e6,-12px_-12px_24px_#ffffff] hover:shadow-[16px_16px_32px_#d1d9e6,-16px_-16px_32px_#ffffff] transition-all group flex flex-col border border-transparent hover:border-brand-primary/10 h-full text-left"
              >
